...
NeVariableData*mVariableData;NeVariableData*mDiscreteData;NeObservableData*
mObservableData;NeModeData*mMajorModeData;NeZCData*mZCData;NeAssertData*
mAssertData;NeAssertData*mParamAssertData;NeAssertData*mInitialAssertData;
NeRange*mRanges;NeRange*mEquationRanges;NeRange*mAssertRanges;NeRange*
mParamAssertRanges;NeRange*mInitialAssertRanges;NeParameterInfo mParameterInfo
;const PmBoolVector*mDirectFeedthrough;const PmIntVector*mOutputFunctionMap;
size_t mNumIo[NUM_IO_TYPES];const SscIoInfo*mIo[NUM_IO_TYPES];NeChecksum*
mChecksum;NeProfiler*mProfiler;NeDaePrivateData*mPrivateData;void(*mDestroy)(
NeDae*);NeDae*(*mCloneFcn)(const NeDae*);NeDaeMethod mMethods[
NE_NUM_DAE_METHODS];NeDaeSolve mSolves[NE_DAE_SOLVE_NUM];NeDaeSolve mCheck;
NeDaeSetParameters mSetParameters;NeDaeFunction mPreTrDiagnoseFcn;
NeDaeFunction mPreDcDiagnoseFcn;NeDaeReportFcn mPushInfo;NeDaeSolve
