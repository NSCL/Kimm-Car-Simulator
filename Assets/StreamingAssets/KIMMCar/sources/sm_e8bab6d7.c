...
]=0;}void sm_core_SmBoundedSet_copy(sm_koCjJG_z1QWpXeGI5fHIzh*copy,const
sm_koCjJG_z1QWpXeGI5fHIzh*orig){const size_t n=orig->sm_VobqE_as4__3W9a6zbgq0x
;copy->sm_VobqE_as4__3W9a6zbgq0x=n;copy->sm_FgUP9l3DqHWwgy6WveH3ZJ=pmf_malloc(
n*sizeof(unsigned char));(void)0;;memcpy(copy->sm_FgUP9l3DqHWwgy6WveH3ZJ,orig
