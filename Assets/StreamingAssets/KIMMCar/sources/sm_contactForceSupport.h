...
real_T springConstant,real_T damperConstant,real_T transRegWidth,real_T
coeffDynamicFric,real_T staticFricMult,real_T velocityDivisor,const real_T*
normalForceInput,const pm_math_Vector2*frictionalForceInput,real_T*
normalVelocity,pm_math_Vector2*tangentialVelocity,real_T*normalForce,real_T*
frictionalForceMag,pm_math_Matrix3x3*baseRotation,pm_math_Vector3*
baseTranslation,pm_math_Matrix3x3*follRotation,pm_math_Vector3*follTranslation
);void sm_core_compiler_computePlanarContactWrenches(int32_T pointFlag,size_t
...
real_T springConstant,real_T damperConstant,real_T transRegWidth,real_T
coeffDynamicFric,real_T staticFricMult,real_T velocityDivisor,const real_T*
normalForceInput,const real_T*frictionalForceInput,real_T*normalVelocity,
real_T*tangentialVelocity,real_T*normalForce,real_T*frictionalForceMag,
pm_math_Matrix3x3*baseRotation,pm_math_Vector3*baseTranslation,
pm_math_Matrix3x3*follRotation,pm_math_Vector3*follTranslation);
#ifdef __cplusplus
}
#endif /* __cplusplus */
