...
pm_math_lin_alg_svdSolveAdaptiveFromFactorization(uint32_T m,uint32_T n,const
real_T*A,const real_T*Sdiag,const real_T*U,const real_T*V,const real_T*b,
real_T minRankTol,real_T maxRankTol,real_T improvementThreshold,real_T*x,
real_T*work);uint32_T
pm_math_lin_alg_svdSolveAdaptiveFromFactorizationReqdWorkSize(uint32_T m,
uint32_T n);uint32_T pm_math_lin_alg_svdComputeRank(uint32_T m,uint32_T n,
const real_T*Sdiag,real_T rankTol);
#ifdef __cplusplus
}
#endif /* __cplusplus */
