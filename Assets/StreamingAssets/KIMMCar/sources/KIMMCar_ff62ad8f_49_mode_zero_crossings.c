...
const NeZCData *KIMMCar_ff62ad8f_49_ZCData = NULL;
PmfMessageId KIMMCar_ff62ad8f_49_computeAsmModeVector(const double *input, const
...
PmfMessageId KIMMCar_ff62ad8f_49_computeSimModeVector(const double *input, const
  double *inputDot, const double *inputDdot, int *modeVector, double
  *errorResult, NeuDiagnosticManager *neDiagMgr)
{
  (void) input;
...
PmfMessageId KIMMCar_ff62ad8f_49_computeZeroCrossings(const
